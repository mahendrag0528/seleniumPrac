...
/*
    login page has incorrect details then forgot password and reset password and login then successful. it happens automatically..
 */
public class DifferentWayOfLocators { 
